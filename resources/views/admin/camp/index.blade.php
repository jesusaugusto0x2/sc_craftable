...
@section('title', trans('admin.camp.actions.index'))
                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/camps/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.camp.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
