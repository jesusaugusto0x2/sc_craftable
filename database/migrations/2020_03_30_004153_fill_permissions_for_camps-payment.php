...
class FillPermissionsForCampsPayment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCampsPayment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.camps-payment',
            'admin.camps-payment.index',
            'admin.camps-payment.create',
            'admin.camps-payment.show',
            'admin.camps-payment.edit',
            'admin.camps-payment.delete',
            'admin.camps-payment.bulk-delete',
        ]);
